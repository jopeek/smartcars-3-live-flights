...
const SearchFlightsContent = (props) => {
  ...
  const getFlights = async () => {
    try {
      let params = {};
      if (depApt.length >= 3)
        params.departure = depApt.substring(0, Math.min(4, depApt.length));
      if (arrApt.length >= 3)
        params.arrival = arrApt.substring(0, Math.min(4, arrApt.length));
      ...
      if (aircraft !== undefined && aircraft !== "") params.aircraft = aircraft;
          ...
          <tbody>
            <tr>
              ...
              <td>
                <div className="ml-3">
                  <h3>Flight Center</h3>
                  <h2 className="color-accent-bkg">Search Schedules</h2>
                </div>
              </td>
            </tr>
          </tbody>
      ...
      <div className="groupbox mb-3 p-3 mx-8">
        ...
        <div className="grid grid-cols-4">
          <div className="col-span-2 mr-1 pt-3">
            ...
            <div className="mt-3 grid grid-cols-2">
              <div className="col-span-1">
                {durations[0] > 0
                  ? durations[0] + " hour" + (durations[0] > 1 ? "s" : "")
                  : "Any"}
              </div>
              <div className="col-span-1 text-right">
                {durations[1] < 11
                  ? durations[1] + " hour" + (durations[1] > 1 ? "s" : "")
                  : "Any"}
              </div>
            </div>
          </div>
          ...
          <div className="col-span-2 ml-1 pt-3">
            ...
            <div className="mt-3 grid grid-cols-2">
              <div className="col-span-1">
                {distances[0] > 0 ? distances[0] * 300 + "nm" : "Any"}
              </div>
              <div className="col-span-1 text-right">
                {distances[1] < 11 ? distances[1] * 300 + "nm" : "Any"}
              </div>
            </div>
          </div>
        </div>
